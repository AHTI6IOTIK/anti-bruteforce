...
const (
	AntiBruteforce_AllowRequest_FullMethodName        = "/service.AntiBruteforce/AllowRequest"
	AntiBruteforce_ClearBucket_FullMethodName         = "/service.AntiBruteforce/ClearBucket"
	AntiBruteforce_AddToBlackList_FullMethodName      = "/service.AntiBruteforce/AddToBlackList"
	AntiBruteforce_AddToWhiteList_FullMethodName      = "/service.AntiBruteforce/AddToWhiteList"
	AntiBruteforce_RemoveFromBlackList_FullMethodName = "/service.AntiBruteforce/RemoveFromBlackList"
	AntiBruteforce_RemoveFromWhiteList_FullMethodName = "/service.AntiBruteforce/RemoveFromWhiteList"
)
...
func (c *antiBruteforceClient) AllowRequest(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, AntiBruteforce_AllowRequest_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *antiBruteforceClient) ClearBucket(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, AntiBruteforce_ClearBucket_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AntiBruteforce_AllowRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AntiBruteforce_AllowRequest_FullMethodName,
	}
...
func _AntiBruteforce_ClearBucket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AntiBruteforce_ClearBucket_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var AntiBruteforce_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "anti-bruteforce.proto",
}
