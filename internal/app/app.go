...
import (
	...
	"github.com/AHTI6IOTIK/anti-bruteforce/internal/controller/repo"
	"github.com/AHTI6IOTIK/anti-bruteforce/internal/usecase"
	"github.com/AHTI6IOTIK/anti-bruteforce/pkg/grpcserver"
	"github.com/AHTI6IOTIK/anti-bruteforce/pkg/logger"
	"github.com/AHTI6IOTIK/anti-bruteforce/pkg/postgres"
...
func Run(cfg *config.Config) {
	...
	if er := listRepo.Up(); er != nil {
		logg.Error(fmt.Sprintf("app - Run - listRepo.Up: %v", er))
	}
